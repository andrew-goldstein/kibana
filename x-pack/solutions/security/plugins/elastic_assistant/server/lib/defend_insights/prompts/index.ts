...
import type { DefendInsightsCombinedPrompts } from '@kbn/discoveries/impl/defend_insights/graphs';
import { InvalidDefendInsightTypeError } from '@kbn/discoveries/impl/lib/errors';
