...
export type {
  ...
  GraphInsightTypes,
} from '@kbn/discoveries/impl/lib/types';
export type {
  DefaultAttackDiscoveryGraph,
  GetDefaultAttackDiscoveryGraphParams,
} from '@kbn/discoveries/impl/attack_discovery/graphs';
export { getDefaultAttackDiscoveryGraph } from '@kbn/discoveries/impl/attack_discovery/graphs';
export type {
  DefaultDefendInsightsGraph,
  GetDefaultDefendInsightsGraphParams,
} from '@kbn/discoveries/impl/defend_insights/graphs';
export { getDefaultDefendInsightsGraph } from '@kbn/discoveries/impl/defend_insights/graphs';

import { getDefaultAttackDiscoveryGraph } from '@kbn/discoveries/impl/attack_discovery/graphs';
import { getDefaultDefendInsightsGraph } from '@kbn/discoveries/impl/defend_insights/graphs';
import type {
  AttackDiscoveryGraphMetadata,
  DefendInsightsGraphMetadata,
  GetAttackDiscoveryGraph,
